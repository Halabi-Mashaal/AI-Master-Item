"""
Advanced AI Model Integration for OpenAI and Gemini
Provides intelligent contextual responses and file analysis
"""
...
class AdvancedAIProvider:
    ...
    def __init__(self):
        ...
        if self.provider not in ['openai', 'gemini'] or (self.provider == 'openai' and not self.openai_client) or (self.provider == 'gemini' and not self.gemini_model):
            ...
            logging.info("⚠️ Using fallback AI provider - Add API keys for advanced features")
...
**🚀 For Advanced AI Analysis:** Configure OpenAI or Gemini API keys in your .env file
...
**To unlock full potential:** Add your API key to `.env` file and restart the application."""
...
**🎯 For Intelligent File Analysis:** Add OpenAI or Gemini API key to your .env file

**Current File Processing:**
• File format detection and validation
• Basic data extraction and structure analysis  
• Industry-specific insights and patterns
• Quality assessment recommendations

**Enhanced with AI:** Deep content analysis, advanced insights, and contextual recommendations."""
        
        else:
            response = f"""I'm here to help with cement industry operations and data analysis.
...
**🚀 Upgrade to AI-Powered:** Configure OpenAI or Gemini API keys for:
• Advanced contextual responses
• Deep file content analysis  
• Intelligent pattern recognition
• Industry-specific AI recommendations

**Current Status:** Using basic fallback mode - {context.get('conversation_length', 0)} conversations stored."""
...
For advanced AI-powered file analysis with detailed insights, patterns recognition, and industry-specific recommendations, please:

1. Add your OpenAI or Gemini API key to the `.env` file
...
**Current Status:** Basic analysis mode active."""
...
def get_ai_response(message: str, context: Dict = None) -> str:
    ...
    result = ai_provider.generate_response(message, context)
    return result.get('response', 'Sorry, I encountered an error generating a response.')

def analyze_uploaded_file(file_content: str, filename: str, user_query: str = "") -> str:
    """Analyze uploaded file content using AI"""
    result = ai_provider.analyze_file_content(file_content, filename, user_query)
    return result.get('response', 'Sorry, I encountered an error analyzing the file.')
